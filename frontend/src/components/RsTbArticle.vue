    ...
    mounted: function () {
      ...
      Blockly.Blocks['testCase'] = {
        init: function () {
          this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldTextInput('Test Case'), 'testCase')
          this.appendStatementInput('NAME')
            .setCheck(null)
          this.setPreviousStatement(true, null)
          this.setNextStatement(true, null)
      ...
      Blockly.Blocks['api'] = {
        init: function () {
          this.appendDummyInput()
            .appendField('API')
            .appendField(new Blockly.FieldDropdown([['Post', 'Post'], ['Get', 'Get'], ['Delete', 'Delete'], ['Put', 'Put']]), 'NAME')
      ...
      Blockly.Css.CONTENT = ['.blocklySvg {', 'background-color: #F3F7FB;', 'outline: none;', 'overflow: hidden;', 'position: absolute;', 'display: block;', '}', '.blocklyWidgetDiv {', 'display: none;', 'position: absolute;', 'z-index: 99999;', '}', '.injectionDiv {', 'height: 100%;', 'position: relative;', 'overflow: hidden;', 'touch-action: none', '}', '.blocklyNonSelectable {', 'user-select: none;', '-moz-user-select: none;', '-ms-user-select: none;', '-webkit-user-select: none;', '}', '.blocklyWsDragSurface {', 'display: none;',
        ...
        'fill: #000;', '}', '.blocklyEditableText:hover>rect {', 'stroke: #fff;', 'stroke-width: 2;', '}', '.blocklyBubbleText {', 'fill: #000;', '}', '.blocklyFlyout {', 'position: absolute;', 'z-index: 20;', 'margin-left: 12px;', 'top: 10px;', 'height: 230px;', 'padding: 0px;', 'border-radius: 15px;', 'border: 1px solid #EBF0F4;', '}', '.blocklyFlyoutButton {', 'fill: #888;', 'cursor: default;', '}', '.blocklyFlyoutButtonShadow {', 'fill: #666;', '}', '.blocklyFlyoutButton:hover {', 'fill: #aaa;', '}', '.blocklyFlyoutLabel {', 'cursor: default;', '}', '.blocklyFlyoutLabelBackground {', 'opacity: 0;', '}', '.blocklyFlyoutLabelText {', 'fill: #000;', '}', '.blocklySvg text, .blocklyBlockDragSurface text {',
        ...
        'stroke: #fc3;', '}', '.blocklyHtmlInput {', 'border: none;', 'border-radius: 4px;', 'font-family: sans-serif;', 'height: 100%;', 'margin: 0;', 'outline: none;', 'padding: 0 1px;', 'width: 100%', '}', '.blocklyMainBackground {', 'stroke-width: 1;', 'stroke: #c6c6c6;', '}', '.blocklyMutatorBackground {', 'fill: #fff;', 'stroke: #000;', 'stroke-width: 1;', '}', '.blocklyFlyoutBackground {', 'fill: #fff;', 'fill-opacity: .8;', 'margin-left: 12px;', '}', '.blocklyTransparentBackground {', 'opacity: 0;', '}', '.blocklyMainWorkspaceScrollbar {', 'z-index: 20;',
        ...
        'border: 0px solid #000;', 'color: #fff;', '}', '.blocklyWidgetDiv .goog-menu {', 'background: #fff;', 'border-color: #ccc #666 #666 #ccc;', 'border-style: solid;', 'border-width: 1px;', 'cursor: default;', 'font: normal 13px Arial, sans-serif;', 'margin: 0;', 'outline: none;', 'padding: 4px 0;', 'position: absolute;', 'overflow-y: auto;', 'overflow-x: hidden;', 'max-height: 100%;', 'z-index: 20000;', '}', '.blocklyWidgetDiv .goog-menuitem {', 'color: #000;', 'font: normal 13px Arial, sans-serif;', 'list-style: none;',
