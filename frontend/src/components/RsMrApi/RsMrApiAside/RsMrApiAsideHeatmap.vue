<template>
  <div class="rs-mr-api-aside-heatmap">
    ...
    <div class="rs-heatmap-y-label">
      <div class='rs-heatmap-y-label-li' v-for="(value,key) in yLabel" :key="key"
           :style="{'width': '100%', 'height': 100 / yLabel.length + '%'}">
    ...
    <div class="rs-heatmap-x-label">
      <div class='rs-heatmap-x-label-li' v-for="(value,key) in xLabel" :key="key"
           :style="{'width': 100 / xLabel.length + '%', 'height': '100%'}">
...
<script>
  ...
  export default {
    ...
    components: {
      ...
      RsMrCardMiniResponseTimeItem,
      RsMrCardMiniResponseTimeHeatMap,
      RsMrCardMiniResponseTimeXLabelItem,
      RsMrCardMiniResponseTimeYLabelItem
    },
    created: function () {
